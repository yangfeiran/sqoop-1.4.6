...
public class SqoopOptions implements Cloneable {
  ...
  public String getIncrementalOffset() {
    return incrementalOffset;
  }

  public void setIncrementalOffset(String incrementalOffset) {
    this.incrementalOffset = incrementalOffset;
  }

  // incremental import offset.
  @StoredAsProperty("incremental.offset")
  private String incrementalOffset;
